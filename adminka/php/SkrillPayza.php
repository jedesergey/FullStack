...
$sql = mysql_query("SELECT * FROM testdata WHERE id='2' ", $link);
...
$result = mysql_query("DROP TABLE SkrillPayza", $link); 
	
$result2 = mysql_query("CREATE TABLE SkrillPayza
...
mysql_query("INSERT INTO SkrillPayza (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM SkrillPayza ", $link);
$i=1;
...
$i++;
$stringfile18[$i] = '];';
file_put_contents("../ohlc/SkrillPayza.js", $stringfile18);	
?>