...
$sql = mysql_query("SELECT * FROM testdata WHERE id='14' ", $link);
...
$result = mysql_query("DROP TABLE PayzaMonero", $link); 
	
$result2 = mysql_query("CREATE TABLE PayzaMonero
...
mysql_query("INSERT INTO PayzaMonero (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM PayzaMonero ", $link);
$i=1;
$stringfile8[0] = 'PayzaMonero = [';
...
$i++;
$stringfile8[$i] = '];';
file_put_contents("../ohlc/PayzaMonero.js", $stringfile8);	
?>