...
$sql = mysql_query("SELECT * FROM testdata WHERE id='13' ", $link);
...
$result = mysql_query("DROP TABLE PayzaPayeer", $link); 
	
$result2 = mysql_query("CREATE TABLE PayzaPayeer
...
mysql_query("INSERT INTO PayzaPayeer (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM PayzaPayeer ", $link);
$i=1;
...
$i++;
$stringfile10[$i] = '];';
file_put_contents("../ohlc/PayzaPayeer.js", $stringfile10);	
