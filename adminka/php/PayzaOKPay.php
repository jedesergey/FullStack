...
$sql = mysql_query("SELECT * FROM testdata WHERE id='12' ", $link);
...
$result = mysql_query("DROP TABLE PayzaOKPay", $link); 
	
$result2 = mysql_query("CREATE TABLE PayzaOKPay
...
mysql_query("INSERT INTO PayzaOKPay (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM PayzaOKPay ", $link);
$i=1;
$stringfile9[0] = 'PayzaOKPay = [';
...
$i++;
$stringfile9[$i] = '];';
file_put_contents("../ohlc/PayzaOKPay.js", $stringfile9);	
?>