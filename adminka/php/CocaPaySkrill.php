...
$sql = mysql_query("SELECT * FROM testdata WHERE id='6' ", $link);
...
$result = mysql_query("DROP TABLE CocaPaySkrill", $link); 
	
$result2 = mysql_query("CREATE TABLE CocaPaySkrill
...
mysql_query("INSERT INTO CocaPaySkrill (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM CocaPaySkrill ", $link);
$i=1;
...
$i++;
$stringfile6[$i] = '];';
file_put_contents("../ohlc/CocaPaySkrill.js", $stringfile6);	
?>