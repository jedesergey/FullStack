...
$sql = mysql_query("SELECT * FROM testdata WHERE id='9' ", $link);
...
$result = mysql_query("DROP TABLE PerfectMoneyPayeer", $link); 
	
$result2 = mysql_query("CREATE TABLE PerfectMoneyPayeer
...
mysql_query("INSERT INTO PerfectMoneyPayeer (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM PerfectMoneyPayeer ", $link);
$i=1;
...
$i++;
$stringfile13[$i] = '];';
file_put_contents("../ohlc/PerfectMoneyPayeer.js", $stringfile13);	
?>