...
$sql = mysql_query("SELECT * FROM testdata WHERE id='10' ", $link);
...
$result = mysql_query("DROP TABLE PerfectMoneyMonero", $link); 
	
$result2 = mysql_query("CREATE TABLE PerfectMoneyMonero
...
mysql_query("INSERT INTO PerfectMoneyMonero (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM PerfectMoneyMonero ", $link);
$i=1;
...
$i++;
$stringfile11[$i] = '];';
file_put_contents("../ohlc/PerfectMoneyMonero.js", $stringfile11);	
?>