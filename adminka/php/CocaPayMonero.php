...
$sql = mysql_query("SELECT * FROM testdata WHERE id='19' ", $link);
...
mysql_query("DROP TABLE CocaPayMonero", $link); 
	
mysql_query("CREATE TABLE CocaPayMonero
...
mysql_query("INSERT INTO CocaPayMonero (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);

mysql_query("DROP TABLE mesbars", $link);    
}	

$sql = mysql_query("SELECT * FROM CocaPayMonero ", $link);
$i=1;
...
$i++;
$stringfile[$i] = '];';
file_put_contents("../ohlc/CocaPayMonero.js", $stringfile);	
