...
session_start();
if (!isset($_SESSION['SkrillPerfectMoney'])) {    
$_SESSION['SkrillPerfectMoney'] = 0; 
}
...
if($_SESSION['SkrillPerfectMoney'] == 1){
$dis2 = 'disabled="disabled"'; 
$ch1 = 'SkrillPerfectMoney';
$interval = '1 days';
$format = '%b %e';
$mintime = $minday; 
$maxtime = $maxday;    
...
$ch1 = 'ohlcordersSkrillPerfectMoney';
$interval = '1 hours';
$format = '%R';
...
<img src='../images/1px.png' class='main-s main-s-bitcoin_small' alt='bitcoin_small'/> <b class='money_Skrill'>0</b> Skrill
</div>
<div class='clear'></div>
</div>
</div></div>
...
?>
                ...
                <head>
                    ...
                    <title>Skrill/PerfectMoney</title>
                    <meta name="robots" content="index, follow">
                    <meta name="keywords" content="">
                    <meta name="description" content="Skrill-E">
                    <meta charset="utf-8">
                    ...
                    <script src="/realorders/SkrillPerfectMoney.js"></script>
                ...
                ?>
                        ...
                        <div id="noticebuy" class="npop block" style="width: 430px; height: 70px; margin-top: -35px; margin-left: -215px; display: none;">
                            ...
                            <div style="float:left; margin-left: 20px; width: 220px;"><a href="javascript:void(0)" id="b1" onclick="buy(this.id)" class="button center">Yes</a></div>
                        ...
                        <div id="noticesell" class="npop block" style="width: 430px; height: 70px; margin-top: -35px; margin-left: -215px; display: none;">
                            <h1 style="color: #c92d2d; margin: 10px;" class="tcenter">You really want to create the order?</h1>
                            <div style="float:left; margin-left: 20px; width: 220px;"><a href="javascript:void(0)" id="s1" onclick="sell(this.id)" class="button center">Yes</a></div>
                        ...
                        <div id="header">
                            <div id="header-content">
                                ...
                                <div id="header-ticker">
                                    <div id="orders-stats">
                                        <div class="orderStats">Last Price: <strong>282.9498 PerfectMoney</strong></div>
                                        <div class="orderStats">Low: <strong>266.1757 PerfectMoney</strong></div>
                                        <div class="orderStats">High: <strong>284.29 PerfectMoney</strong></div>
                                        <div class="clear"></div>
                                        <div class="orderStats">Volume: <strong></strong></div>
                                        <div class="orderStats">Server Time: <strong><?echo $today;?></strong></div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                                <? echo $noauth; ?>
                                    <? echo $a; ?>
										...
										<a href="https://Skrill-e.com/setlocale/en"><img src="/images/1px.png" class="main-s main-s-en" alt="en"></a>
										<a href="https://Skrill-e.com/setlocale/ru"><img src="/images/1px.png" class="main-s main-s-ru" alt="ru"></a>
										<a href="https://Skrill-e.com/setlocale/cn"><img src="/images/1px.png" class="main-s main-s-cn" alt="cn"></a>
									</div> -->
                                        </div>
                            </div>
                        </div>
...
?>
                                ...
                                <div class="block">
                                    ...
                                    <ul class="pairs">
                                        <li class="pairs-selected">Skrill/PerfectMoney<span style="display:block">0.364</span></li>
                                        ...
                                        <li><a href="/exchange/skrillpayeer.php">Skrill/Payeer<span style="display:block">0.364</span></a></li>
                                        <li><a href="/exchange/skrillmonero.php">Skrill/Monero<span style="display:block">0.00118</span></a></li>
                                        <li><a href="/exchange/cocapayskrill.php">CocaPay/Skrill<span style="display:block">69.08349</span></a></li>
                                        <li><a href="/exchange/perfectmoneypayza.php">PerfectMoney/Payza<span style="display:block">1.08763</span></a></li>
                                        <li><a href="/exchange/perfectmoneyokpay.php">PerfectMoney/OKPay<span style="display:block">0.861</span></a></li>
                                        <li><a href="/exchange/perfectmoneypayeer.php">PerfectMoney/Payeer<span style="display:block">62.95501</span></a></li>
                                        <li><a href="/exchange/perfectmoneymonero.php">PerfectMoney/Monero<span style="display:block">0.00283</span></a></li>
                                        <li><a href="/exchange/cocapayperfectmoney.php">CocaPay/PerfectMoney<span style="display:block">0.353</span></a></li>
                                        <li><a href="/exchange/payzaokpay.php">Payza/OKPay<span style="display:block">2.76</span></a></li>
                                        <li><a href="/exchange/payzapayeer.php">Payza/Payeer<span style="display:block">0.00115</span></a></li>
                                        <li><a href="/exchange/payzamonero.php">Payza/Monero<span style="display:block">190.90299</span></a></li>
                                        <li><a href="/exchange/cocapaypayza.php">CocaPay/Payza<span style="display:block">3.009269</span></a></li>
                                        <li><a href="/exchange/okpaypayeer.php">OKPay/Payeer<span style="display:block">307.856</span></a></li>
                                        <li><a href="/exchange/cocapayokpay.php">CocaPay/OKPay<span style="display:block">19400</span></a></li>
                                    ...
                                    <div dir="ltr" style=" width: 993px; height: 200px;">
                                        ...
                                        <div style="width:920px; height:20px; text-align: center; margin: 10px 0 0 30px; ">
                                            <h1 id="n0">Skrill/PerfectMoney</h1></div>
                                    ...
                                    <div class="inblock" style="width: 470px; float: left;">
                                        <h1>Buy Skrill</h1>
                                        <input id="pair" value="19" type="hidden">
                                        <div class="inblock order_header">
                                            <div style="width: 130px;  float: left;">Your balance:
                                                <p><a href="javascript:void(0)" onclick="a_calc(19)"><b><span id="cur1" class="money_PerfectMoney">0</span><input id="cur1_full" value="0" type="hidden"> PerfectMoney</b></a></p>
                                            </div>
                                            <div style="width: 130px; float: right;">Lowest ask Price
                                                <p><b><span id="min_price">0</span> PerfectMoney</b></p>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
                                        <table class="inblock tabla2" style="width: 100%;">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 150px;">Amount Skrill:</td>
                                                    <td style="width: 153px;">
                                                        <input id="b_Skrill" onkeyup="sendbuy()" style="width: 110px;" maxlength="25" value="0"  type="text">
                                                    </td>
                                                </tr>
                                                <tr class="price-row">
                                                    <td>Price per Skrill:</td>
                                                    <td>
                                                        <input id="b_price" onkeyup="sendbuy()" style="width: 110px;" maxlength="8" value="0" type="text"> PerfectMoney</td>
                                                </tr>
                                                <tr>
                                                    <td>Total:</td>
                                                    <td><b id="b_all">0</b> <b>PerfectMoney</b></td>
                                                </tr>
                                                <tr>
                                                    <td>Fee:</td>
                                                    <td><b id="b_fee">0</b> <b>PerfectMoney</b></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <a href="javascript:void(0)"  onclick="noticebuy()" class="button" style="float: right;">Buy Skrill</a>
                                        ...
                                        <div class="inblock"><img class="orders-loading" alt="loading">
                                            ...
                                            <div id="orders-s-list">
                                                <p class="gray" style="text-align: right;">Total: 551.42 Skrill</p>
                                                <div id="orders_1" style="overflow-y: auto; overflow-x: hidden; max-height: 485px;">
                                                    <table class="table" style="width: 99%">
                                                        <tbody>
                                                            <tr>
                                                                <th width="33%">price</th>
                                                                <th width="33%">Skrill</th>
                                                                <th width="33%">PerfectMoney</th>
                                                            </tr>
<?                       
...
$red = mysql_query("SELECT * FROM ordersSkrillPerfectMoney WHERE action='0' AND type='sell' AND time < '$date'");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$red = mysql_query("SELECT * FROM realSkrillPerfectMoney WHERE action='0' AND type='sell' ");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
?>
                                    ...
                                    <div class="inblock" style="width: 470px; float: right;">
                                        ...
                                        <div class="inblock order_header">
                                            <div style="width: 130px; float: left;">Your balance:
                                                <p><a href="javascript:void(0)" onclick='all_money("cur2_full", "s_Skrill")'><b><span id="cur2" class="money_Skrill">0</span><input id="cur2_full" value="0" type="hidden"> Skrill</b></a></p>
                                            </div>
                                            <div style="width: 130px; float: right;">Highest Bid Price
                                                <p><b><span id="max_price">0</span> PerfectMoney</b></p>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
                                        <table class="inblock tabla2" style="width: 100%;">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 150px;">Amount Skrill:</td>
                                                    <td style="width: 153px;">
                                                        <input id="s_Skrill" onkeyup="sendsell()" style="width: 110px;" maxlength="25" value="0"  type="text">
                                                    </td>
                                                </tr>
                                                <tr class="price-row">
                                                    <td>Price per Skrill:</td>
                                                    <td>
                                                        <input id="s_price" onkeyup="sendsell()" style="width: 110px;" maxlength="8" value="0"  type="text"> PerfectMoney</td>
                                                </tr>
                                                <tr>
                                                    <td>Total:</td>
                                                    <td><b id="s_all">0</b> <b>PerfectMoney</b></td>
                                                </tr>
                                                <tr>
                                                    <td>Fee:</td>
                                                    <td><b id="s_fee">0</b> <b>PerfectMoney</b></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <a href="javascript:void(0)"  onclick="noticesell()" class="button" style="float: right;">Sell Skrill</a>
                                        ...
                                        <div class="inblock"><img class="orders-loading" alt="loading">
                                            ...
                                            <div id="orders-b-list">
                                                <p class="gray" style="text-align: right;">Total: 215365.44 PerfectMoney</p>
...
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM ordersSkrillPerfectMoney WHERE action='0' AND type='buy' AND time < '$date'");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$red = mysql_query("SELECT * FROM realSkrillPerfectMoney WHERE action='0' AND type='buy' ");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$user = $_SESSION['user'];
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM realSkrillPerfectMoney WHERE action='0' AND user='$user' AND time <= '$date' ORDER BY time DESC");
while ($row = mysql_fetch_array($red)){  
$price = $row['price'];
$amount = $row['amount'];
$total = $row['total'];
                                            ...
                                            <table class="table" style="width: 100%">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th width="20%">Amount (Skrill)</th>
                                                        <th width="25%">Total (PerfectMoney)</th>
                                                    </tr>
<?
mysql_query("CREATE TABLE zzz
( `id` int(100) NOT NULL AUTO_INCREMENT,
...
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM ordersSkrillPerfectMoney WHERE action='1' AND time2 <= '$date' ORDER BY time2 DESC");
while ($row = mysql_fetch_array($red)){  
$time2 = $row['time2'];
$type2 = $row['type2'];
$price2 = $row['price'];
...
$red = mysql_query("SELECT * FROM realSkrillPerfectMoney WHERE action='1'");
while ($row = mysql_fetch_array($red)){  
$time2 = $row['time2'];
$type2 = $row['type2'];
$price2 = $row['price'];
                        ...
                        <div id="footer">
                            <div id="footer-content">
                                <div style="width: 550px; float:left;">
                                    <p class="copyrights">Copyright © 2011-2015 Skrill-e.com. All rights reserved.</p>
                                    <p class="copyrights">
                                        <a href="https://Skrill-e.com/api/3/docs">Public API</a> |
                                        <a href="https://Skrill-e.com/tapi/docs">Trade API</a> |
