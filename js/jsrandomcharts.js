$('#one').on('click', function (e) {
	...
	$("#one").queue(function () { // добавим новую функцию в очередь

		$('#one').fadeOut(animTime);
	...
	$("#one").queue(function (next) { //добавим новую функцию в очередь
		...
		var idx = charts.indexOf(idclick2);
