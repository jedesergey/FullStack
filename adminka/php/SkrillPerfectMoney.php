...
$result = mysql_query("DROP TABLE SkrillPerfectMoney", $link); 
	
$result2 = mysql_query("CREATE TABLE SkrillPerfectMoney
...
mysql_query("INSERT INTO SkrillPerfectMoney (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM SkrillPerfectMoney ", $link);
$i=1;
...
$i++;
$stringfile19[$i] = '];';
file_put_contents("../ohlc/SkrillPerfectMoney.js", $stringfile19);	
?>