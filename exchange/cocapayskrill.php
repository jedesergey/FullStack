...
session_start();
if (!isset($_SESSION['CocaPaySkrill'])) {    
$_SESSION['CocaPaySkrill'] = 0; 
}
...
if (@$_REQUEST['hourly']) {
$_SESSION['CocaPaySkrill'] = 0;    
header("Location: cocapayskrill.php");

}

if (@$_REQUEST['daily']) {
$_SESSION['CocaPaySkrill'] = 1;   
header("Location: cocapayskrill.php");
...
<img src='../images/1px.png' class='main-s main-s-bitcoin_small' alt='bitcoin_small'/> <b class='money_CocaPay'>0</b> CocaPay
</div>
<div class='clear'></div>
</div>
</div></div>
...
<script src="../realorders/real6.js"></script>
...
<div style="float:left; margin-left: 20px; width: 220px;"><a href="javascript:void(0)" id="b6" onclick="buy(this.id)" class="button center">Yes</a></div>
...
<h1 style="color: #c92d2d; margin: 10px;" class="tcenter">You really want to create the order?</h1>
<div style="float:left; margin-left: 20px; width: 220px;"><a href="javascript:void(0)" id="s6" onclick="sell(this.id)" class="button center">Yes</a></div>
...
<div id="orders-stats">
<div class="orderStats">Last Price: <strong>0.0011 CocaPay</strong></div>
<div class="orderStats">Low: <strong>0.0011 CocaPay</strong></div>
<div class="orderStats">High: <strong>0.0012 CocaPay</strong></div>
<div class="clear"></div>
<div class="orderStats">Volume: <strong>41013 Skrill / 49 CocaPay</strong></div>
...
<a href="https://CocaPay-e.com/setlocale/en"><img src="/images/1px.png" class="main-s main-s-en" alt="en"></a>
<a href="https://CocaPay-e.com/setlocale/ru"><img src="/images/1px.png" class="main-s main-s-ru" alt="ru"></a>
<a href="https://CocaPay-e.com/setlocale/cn"><img src="/images/1px.png" class="main-s main-s-cn" alt="cn"></a>
</div> -->
</div>
</div>
</div>
...
<li class="pairs-selected">CocaPay/Skrill<span style="display:block">0.364</span></li>
...
<h1 id="n0">CocaPay/Skrill</h1></div>

<form action="cocapayskrill.php" method="post">
...
<h1>Buy CocaPay</h1>
<input id="pair" value="24" type="hidden">
<div class="inblock order_header">
<div style="width: 130px; float: left;">Your balance:
<p><a href="javascript:void(0)" onclick="a_calc(24)"><b><span id="cur1" class="money_Skrill">0</span><input id="cur1_full" value="0" type="hidden"> Skrill</b></a></p>
</div>
<div style="width: 130px; float: right;">Lowest ask Price
<p><b><span id="min_price">0</span> Skrill</b></p>
</div>
<div class="clear"></div>
</div>
...
<td>
<input id="b_price" style="width: 110px;" maxlength="8" value="0"  type="text"> Skrill</td>
</tr>
<tr>
<td>Total:</td>
<td><b id="b_all">0</b> <b>Skrill</b></td>
</tr>
<tr>
<td>Fee:</td>
<td><b id="b_fee">0</b> <b>Skrill</b></td>
</tr>
...
<p class="gray" style="text-align: right;">Total: 946756.75 CocaPay</p>
...
$red = mysql_query("SELECT * FROM ordersCocaPaySkrill WHERE action='0' AND type='sell' AND time < '$date'");
...
$red = mysql_query("SELECT * FROM realCocaPaySkrill WHERE action='0' AND type='sell' ");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
<div class="inblock order_header">
<div style="width: 130px; float: left;">Your balance:
<p><a href="javascript:void(0)" onclick='all_money("cur2_full", "s_Skrill")'><b><span id="cur2" class="money_CocaPay">0</span><input id="cur2_full" value="0" type="hidden"> CocaPay</b></a></p>
</div>
<div style="width: 130px; float: right;">Highest Bid Price
<p><b><span id="max_price">0</span> Skrill</b></p>
</div>
<div class="clear"></div>
</div>
<table class="inblock tabla2" style="width: 100%;">
...
<td>Price per CocaPay:</td>
<td>
<input id="s_price" style="width: 110px;" maxlength="8" value="0"  type="text"> Skrill</td>
</tr>
<tr>
<td>Total:</td>
<td><b id="s_all">0</b> <b>Skrill</b></td>
</tr>
<tr>
<td>Fee:</td>
<td><b id="s_fee">0</b> <b>Skrill</b></td>
</tr>
...
<p class="gray" style="text-align: right;">Total: 316.32 Skrill</p>
...
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM ordersCocaPaySkrill WHERE action='0' AND type='buy' AND time < '$date'");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$red = mysql_query("SELECT * FROM realCocaPaySkrill WHERE action='0' AND type='buy' ");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$user = $_SESSION['user'];
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM realCocaPaySkrill WHERE action='0' AND user='$user' AND time < '$date' ORDER BY time DESC");
while ($row = mysql_fetch_array($red)){  
$price = $row['price'];
$amount = $row['amount'];
$total = $row['total'];
...
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM ordersCocaPaySkrill WHERE action='1' AND time2 <= '$date' ORDER BY time2 DESC");
while ($row = mysql_fetch_array($red)){  
$time2 = $row['time2'];
$type2 = $row['type2'];
$price2 = $row['price'];
...
$red = mysql_query("SELECT * FROM realCocaPaySkrill WHERE action='1'");
while ($row = mysql_fetch_array($red)){  
$time2 = $row['time2'];
$type2 = $row['type2'];
$price2 = $row['price'];
...
<p class="copyrights">Copyright © 2011-2015 CocaPay-e.com. All rights reserved.</p>
<p class="copyrights">
<a href="https://CocaPay-e.com/api/3/docs">Public API</a> |
<a href="https://CocaPay-e.com/tapi/docs">Trade API</a> |
