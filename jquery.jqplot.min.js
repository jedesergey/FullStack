  ...
  function R() {
    ...
    this.computePlotData = function () {
      ...
      for (au = 0, ao = this.series.length; au < ao; au++) {
        ...
        var am = at.data;
        this._plotData[au] = L.extend(true, [
        ], am);
        this._stackData[au] = L.extend(true, [
        ], am);
    ...
    this.populatePlotData = function (au, av) {
      ...
      if (this.stackSeries && !au.disableStack) {
        ...
        var az = L.extend(true, [
        ], au.data);
        var aA = L.extend(true, [
        ], au.data);
        var an,
        am,
        ao,
    ...
    this.parseOptions = function (ay) {
      ...
      for (var at = 0; at < 12; at++) {
        var an = U[at];
        var ap = this.axes[an];
        ap._options = L.extend(true, {
        }, am.axesDefaults, am.axes[an]);
...
ap = null;
this.target.trigger('jqplotPostDraw', [
this
])
}
};
...
var av = [
[aj,
ai.getTop() + ai.getHeight() / 2],
[
aj,
al.getTop() + al.getHeight() / 2 + 1
]
];
if (this.shadow) {
...
dotted: [
r,
L.jqplot.config.dotGapLength
],
dashed: [
L.jqplot.config.dashLength,
L.jqplot.config.gapLength
],
solid: null
};
if (typeof aq === 'string') {
...
an.hiData.push([aB[aw][0],
al[aj][aw]]);
an.lowData.push([aB[aw][0],
al[aC][aw]])
}
} else {
an.show = false
...
this.renderer._hiBandGridData.push([al.call(this._xaxis, ak.hiData[an][0]),
ah.call(this._yaxis, ak.hiData[an][1])])
}
for (var an = 0, aj = ak.lowData.length; an < aj; an++) {
this.renderer._lowBandGridData.push([al.call(this._xaxis, ak.lowData[an][0]),
...
this.renderer._hiBandGridData.push([am.call(this._xaxis, al.hiData[an][0]),
ah.call(this._yaxis, al.hiData[an][1])])
}
for (var an = 0, ak = al.lowData.length; an < ak; an++) {
this.renderer._lowBandGridData.push([am.call(this._xaxis, al.lowData[an][0]),
...
am[ai] = L.jqplot.extend(ah, an || (ao.length != null ? [
] : {
}), ao)
} else {
if (ao !== u) {
...
}; L.jqplot.sprintf.thousandsSeparator = ','; L.jqplot.sprintf.decimalMark = '.'; L.jqplot.sprintf.regex = /%%|%(\d+\$)?([-+#0&\' ]*)(\*\d+\$|\*|\d+)?(\.(\*\d+\$|\*|\d+))?([nAscboxXuidfegpEGP])/g; L.jqplot.getSignificantFigures = function (al) {
...
}; var X = L.uiBackCompat !== false; L.jqplot.effects = {
effect: {
}
}; var m = 'jqplot.storage.'; L.extend(L.jqplot.effects, {
version: '1.9pre',
save: function (ai, aj) {
for (var ah = 0; ah < aj.length; ah++) {
if (aj[ah] !== null) {
...
}); var a = /up|down|vertical/, v = /up|left|vertical|horizontal/; L.jqplot.effects.effect.blind = function (aj, ao) {
var ak = L(this),
ar = [
'position',
'top',
