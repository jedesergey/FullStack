...
$sql = mysql_query("SELECT * FROM testdata WHERE id='17' ", $link);
...
$result = mysql_query("DROP TABLE CocaPayOKPay", $link); 
	
$result2 = mysql_query("CREATE TABLE CocaPayOKPay
...
mysql_query("INSERT INTO CocaPayOKPay (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM CocaPayOKPay ", $link);
$i=1;
$stringfile2[0] = 'CocaPayOKPay = [';
...
$i++;
$stringfile2[$i] = '];';
file_put_contents("../ohlc/CocaPayOKPay.js", $stringfile2);	
?>