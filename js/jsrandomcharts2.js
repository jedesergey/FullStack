$('#two').on('click', function (e) {
	...
	$("#two").queue(function () { // добавим новую функцию в очередь

		$('#two').fadeOut(animTime);
	...
	$("#two").queue(function (next) { //добавим новую функцию в очередь
		...
		var idx = charts.indexOf(idclick4);
