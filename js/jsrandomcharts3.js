$('#three').on('click', function (e) {
	...
	$("#three").queue(function () { // добавим новую функцию в очередь

		$('#three').fadeOut(animTime);
	...
	$("#three").queue(function (next) { //добавим новую функцию в очередь
		...
		var idx = charts.indexOf(idclick6);
