...
$f = mysql_query("SELECT * FROM testdata WHERE pair='php/SkrillPayza.php'", $link);
...
$s = mysql_query("SELECT * FROM ordersSkrillPayza WHERE YEAR(time) = '$viewtimes1' AND MONTH(time) = '$viewtimes2' AND DAY(time) = '$viewtimes3' AND HOUR(time) = '$viewtimes4' ORDER BY price DESC", $link);
$row22 = mysql_fetch_array($s);
$lastpricebuy = $row22['price'];

$s3 = mysql_query("SELECT * FROM ordersSkrillPayza WHERE YEAR(time) = '$viewtimes1' AND MONTH(time) = '$viewtimes2' AND DAY(time) = '$viewtimes3' AND HOUR(time) = '$viewtimes4' ORDER BY price ASC", $link);
