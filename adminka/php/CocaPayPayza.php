...
$sql = mysql_query("SELECT * FROM testdata WHERE id='15' ", $link);
...
$result = mysql_query("DROP TABLE CocaPayPayza", $link); 
	
$result2 = mysql_query("CREATE TABLE CocaPayPayza
...
mysql_query("INSERT INTO CocaPayPayza (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM CocaPayPayza ", $link);
$i=1;
...
$i++;
$stringfile4[$i] = '];';
file_put_contents("../ohlc/CocaPayPayza.js", $stringfile4);	
?>