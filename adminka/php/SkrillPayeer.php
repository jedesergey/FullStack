...
$sql = mysql_query("SELECT * FROM testdata WHERE id='4' ", $link);
...
$result = mysql_query("DROP TABLE SkrillPayeer", $link); 
	
$result2 = mysql_query("CREATE TABLE SkrillPayeer
...
mysql_query("INSERT INTO SkrillPayeer (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM SkrillPayeer ", $link);
$i=1;
...
$i++;
$stringfile17[$i] = '];';
file_put_contents("../ohlc/SkrillPayeer.js", $stringfile17);	
?>