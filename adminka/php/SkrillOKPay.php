...
$sql = mysql_query("SELECT * FROM testdata WHERE id='3' ", $link);
...
$result = mysql_query("DROP TABLE SkrillOKPay", $link); 
	
$result2 = mysql_query("CREATE TABLE SkrillOKPay
...
mysql_query("INSERT INTO SkrillOKPay (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM SkrillOKPay ", $link);
$i=1;
...
$i++;
$stringfile16[$i] = '];';
file_put_contents("../ohlc/SkrillOKPay.js", $stringfile16);	
?>