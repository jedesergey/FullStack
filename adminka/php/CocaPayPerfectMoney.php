...
$sql = mysql_query("SELECT * FROM testdata WHERE id='11' ", $link);
...
$result = mysql_query("DROP TABLE CocaPayPerfectMoney", $link); 
	
$result2 = mysql_query("CREATE TABLE CocaPayPerfectMoney
...
mysql_query("INSERT INTO CocaPayPerfectMoney (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM CocaPayPerfectMoney ", $link);
$i=1;
$stringfile5[0] = 'CocaPayPerfectMoney = [';
...
$i++;
$stringfile5[$i] = '];';
file_put_contents("../ohlc/CocaPayPerfectMoney.js", $stringfile5);	
?>