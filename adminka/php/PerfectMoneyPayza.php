...
$sql = mysql_query("SELECT * FROM testdata WHERE id='7' ", $link);
...
$result = mysql_query("DROP TABLE PerfectMoneyPayza", $link); 
	
$result2 = mysql_query("CREATE TABLE PerfectMoneyPayza
...
mysql_query("INSERT INTO PerfectMoneyPayza (data, open, hi, low, close)
VALUES ('$time_d', '$open', '$hi', '$low', '$close')", $link);	
}	

$sql = mysql_query("SELECT * FROM PerfectMoneyPayza ", $link);
$i=1;
...
$i++;
$stringfile14[$i] = '];';
file_put_contents("../ohlc/PerfectMoneyPayza.js", $stringfile14);	
?>