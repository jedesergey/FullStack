...
session_start();
if (!isset($_SESSION['SkrillMonero'])) {    
$_SESSION['SkrillMonero'] = 0; 
}
...
$ch1 = 'ohlcordersSkrillMonero';
$interval = '1 hours';
$format = '%R'; 
$maxtime = date("Y-m-d H:$u:$u",strtotime("+ 0 hours"));
$mintime = date("Y-m-d H:$u:$u",strtotime("- 21 hours"));   
}


if (@$_REQUEST['hourly']) {
$_SESSION['SkrillMonero'] = 0;  
header("Location: skrillmonero.php");

}

if (@$_REQUEST['daily']) {
$_SESSION['SkrillMonero'] = 1;    
header("Location: skrillmonero.php");
...
<img src='../images/1px.png' class='main-s main-s-dollar_small' alt='dollar_small'/> <b class='money_Monero'>0</b> Monero
</div>
<div style='width: 160px; height: 16px; float: left; overflow:hidden;'>
<img src='../images/1px.png' class='main-s main-s-bitcoin_small' alt='bitcoin_small'/> <b class='money_Monero'>0</b> Monero
</div>
<div class='clear'></div>
</div>
</div></div>
...
<script src="../realorders/real5.js"></script>
...
<div style="float:left; margin-left: 20px; width: 220px;"><a href="javascript:void(0)" id="b5" onclick="buy(this.id)" class="button center">Yes</a></div>
...
<h1 style="color: #c92d2d; margin: 10px;" class="tcenter">You really want to create the order?</h1>
<div style="float:left; margin-left: 20px; width: 220px;"><a href="javascript:void(0)" id="s5" onclick="sell(this.id)" class="button center">Yes</a></div>
...
<div id="orders-stats">
<div class="orderStats">Last Price: <strong>0.362 Monero</strong></div>
<div class="orderStats">Low: <strong>0.351 Monero</strong></div>
<div class="orderStats">High: <strong>0.3709 Monero</strong></div>
<div class="clear"></div>
<div class="orderStats">Volume: <strong>28336 Skrill / 10340 Monero</strong></div>
<div class="orderStats">Server Time: <strong>29.10.15 18:44</strong></div>
<div class="clear"></div>
</div>
</div>
<? echo $noauth; ?>
...
<a href="https://Monero-e.com/setlocale/en"><img src="/images/1px.png" class="main-s main-s-en" alt="en"></a>
<a href="https://Monero-e.com/setlocale/ru"><img src="/images/1px.png" class="main-s main-s-ru" alt="ru"></a>
<a href="https://Monero-e.com/setlocale/cn"><img src="/images/1px.png" class="main-s main-s-cn" alt="cn"></a>
</div> -->
</div>
</div>
</div>
...
<li class="pairs-selected">Skrill/Monero<span style="display:block">0.364</span></li>
...
<h1 id="n0">Skrill/Monero</h1></div>

<form action="skrillmonero.php" method="post">
...
<h1>Buy Skrill</h1>
<input id="pair" value="31" type="hidden">
<div class="inblock order_header">
<div style="width: 130px; float: left;">Your balance:
<p><a href="javascript:void(0)" onclick="a_calc(31)"><b><span id="cur1" class="money_Monero">0</span><input id="cur1_full" value="0" type="hidden"> Monero</b></a></p>
</div>
<div style="width: 130px; float: right;">Lowest ask Price
<p><b><span id="min_price">0</span> Monero</b></p>
</div>
<div class="clear"></div>
</div>
...
<td>
<input id="b_price" style="width: 110px;" maxlength="8" value="0"  type="text"> Monero</td>
</tr>
<tr>
<td>Total:</td>
<td><b id="b_all">0</b> <b>Monero</b></td>
</tr>
<tr>
<td>Fee:</td>
<td><b id="b_fee">0</b> <b>Monero</b></td>
</tr>
...
<p class="gray" style="text-align: right;">Total: 683124.92 Skrill</p>
...
$red = mysql_query("SELECT * FROM ordersSkrillMonero WHERE action='0' AND type='sell' AND time < '$date'");
...
$red = mysql_query("SELECT * FROM realSkrillMonero WHERE action='0' AND type='sell' ");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
<div class="inblock order_header">
<div style="width: 130px; float: left;">Your balance:
<p><a href="javascript:void(0)" onclick='all_money("cur2_full", "s_Monero")'><b><span id="cur2" class="money_Skrill">0</span><input id="cur2_full" value="0" type="hidden"> Skrill</b></a></p>
</div>
<div style="width: 130px; float: right;">Highest Bid Price
<p><b><span id="max_price">0</span> Monero</b></p>
</div>
<div class="clear"></div>
</div>
<table class="inblock tabla2" style="width: 100%;">
...
<td>Price per Skrill:</td>
<td>
<input id="s_price" style="width: 110px;" maxlength="8" value="0"  type="text"> Monero</td>
</tr>
<tr>
<td>Total:</td>
<td><b id="s_all">0</b> <b>Monero</b></td>
</tr>
<tr>
<td>Fee:</td>
<td><b id="s_fee">0</b> <b>Monero</b></td>
</tr>
...
<p class="gray" style="text-align: right;">Total: 32890.33 Monero</p>
...
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM ordersSkrillMonero WHERE action='0' AND type='buy' AND time < '$date'");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$red = mysql_query("SELECT * FROM realSkrillMonero WHERE action='0' AND type='buy' ");
while ($row = mysql_fetch_array($red)){  
$time = $row['time'];
$price = $row['price'];
$amount = $row['amount'];
...
$user = $_SESSION['user'];
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM realSkrillMonero WHERE action='0' AND user='$user' AND time < '$date' ORDER BY time DESC");
while ($row = mysql_fetch_array($red)){  
$price = $row['price'];
$amount = $row['amount'];
$total = $row['total'];
...
$date = date("Y-m-d H:i:s");                                                 
$red = mysql_query("SELECT * FROM ordersSkrillMonero WHERE action='1' AND time2 <= '$date' ORDER BY time2 DESC");
while ($row = mysql_fetch_array($red)){  
$time2 = $row['time2'];
$type2 = $row['type2'];
$price2 = $row['price'];
...
$red = mysql_query("SELECT * FROM realSkrillMonero WHERE action='1'");
while ($row = mysql_fetch_array($red)){  
$time2 = $row['time2'];
$type2 = $row['type2'];
$price2 = $row['price'];
...
<p class="copyrights">Copyright © 2011-2015 Monero-e.com. All rights reserved.</p>
<p class="copyrights">
<a href="https://Monero-e.com/api/3/docs">Public API</a> |
<a href="https://Monero-e.com/tapi/docs">Trade API</a> |
